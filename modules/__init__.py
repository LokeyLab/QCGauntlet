...
def renameKeys(
    mainDf: pd.DataFrame, keyDf: pd.DataFrame, renameColumn, left_on=None, **kwargs
):
...
def pyclusterHeatmap_pearsonComplete(
    inTabFile, outname, rowCluster=True, colCluster=True
):
